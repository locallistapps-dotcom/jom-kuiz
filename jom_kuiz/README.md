...
Foundation (Prompt 01) + Authentication module (Prompt 02) are implemented.
No other feature logic (parent/child modules, quiz, wallet, referral,
payment, admin, analytics, AI, OCR, notifications) is implemented yet.
...
placeholder), routing with guarded auth redirects, the Authentication module
described above, localization structure (en/ms), reusable widgets, logging,
global error/exception handling.

Explicitly **not** included yet: parent module, child module,
education/quiz module, wallet, referral, payment, admin dashboard,
